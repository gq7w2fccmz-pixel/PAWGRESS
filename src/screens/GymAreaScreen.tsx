    ...
    <div className="min-h-screen pb-28" style={{ background: "#0a0a0a" }}>
      ...
      <div className="p-4">
        <div className="flex justify-between items-center mb-3">
          ...
          <button className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-[11px] font-bold text-gray-400 tracking-wide" style={{ fontFamily: F, background: "none", border: "1px solid #2a2a2a" }}>▼ FILTERN</button>
        </div>
        <div className="flex flex-col gap-3">
          {area.exercises.map((ex, i) => (
            <div key={i} className="rounded-2xl overflow-hidden" style={{ background: "#161616", border: "1px solid #2a2a2a" }}>
              <div className="flex">
                <div className="relative flex-shrink-0 flex items-end p-2.5" style={{ width: 160, minHeight: 120, background: `linear-gradient(135deg,${area.color}22,#0a0a0a)` }}>
                  ...
                  <div className="absolute bottom-2.5 right-2.5 w-8 h-8 rounded-full flex items-center justify-center text-sm" style={{ background: "rgba(0,0,0,0.7)", border: "1px solid #2a2a2a" }}>▶</div>
                ...
                <div className="flex-1 p-3">
                  <p className="font-black text-[11px] text-gray-400 tracking-wide mb-1" style={{ fontFamily: F }}>ÜBUNGSBESCHREIBUNG</p>
                  <p className="text-[11px] text-gray-200 leading-relaxed mb-2.5">{ex.desc}</p>
                  <p className="font-black text-[11px] text-gray-400 tracking-wide mb-1" style={{ fontFamily: F }}>WIRKUNG</p>
                  <p className="text-[11px] mb-0.5" style={{ color: area.color }}>Hauptsächlich: {ex.primary}</p>
                  <p className="text-[11px] text-gray-400 mb-2.5">Unterstützend: {ex.secondary}</p>
                  <button className="px-3.5 py-1.5 rounded-lg text-[11px] font-bold tracking-wide" style={{ fontFamily: F, background: "none", border: `1px solid ${area.color}`, color: area.color }}>DETAILS ANSEHEN ›</button>
                </div>
              </div>
            </div>
          ))}
